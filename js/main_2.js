...
(function () {
    ...
    self.BoardView.prototype = {
        ...
        check_goal: function(){  // todo lo que tenga R es para hacer los matcadores
			var goal = false; //R
			if (this.board.ball.x >= 800){ //R
				this.marcador_a++; //R
				console.log("Goal A "+this.marcador_a); //R
				this.board.playing = false; //R
				goal = true; //R
			}else if(this.board.ball.x <= 0){ //R
				this.marcador_b++; //R
				console.log("Goal B "+this.marcador_b); //R
				this.board.playing = false; //R
				goal = true; //R
			} //R
			return goal; //R
        ...
        refresh_scoreboard: function(){
			var sbA = document.getElementById('teamA').innerHTML = this.marcador_a.toString(); //R
			var sbB = document.getElementById('teamB').innerHTML = this.marcador_b.toString(); //R
		}, //R
        play: function () {  
